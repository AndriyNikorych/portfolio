...
import { TravelCards } from "@/modules/travel/TravelCards";
...
export function Travel() {
	...
	useEffect(() => {
		...
		tl.fromTo(titleRef.current, { opacity: 0, x: 100 }, { opacity: 1, x: 0, duration: 0.1 }, 0.3);
		tl.fromTo(subtitleRef.current, { opacity: 0, x: 100 }, { opacity: 1, x: 0, duration: 0.1 }, 0.35);
